      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-12 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="{{ route('admin.tambah-pengguna') }}">
                @csrf
                <div class="mb-3">
                ...
                <div class="form-floating mb-3">
                    <select class="form-select" id="level" aria-label="Floating label select example" name="level">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 mt-2 mb-2">Tambah Pengguna</button>
                </div>
              </form>
              <div class="text-center">
              <a href="{{route('admin.tampil-pengguna')}}" class="btn bg-gradient-info w-100 mb-2">Kembali</a>
                </div>
            </div>
          </div>
        </div>
